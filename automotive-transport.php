    ...
    <section class="our-rd-services-top container f-shadow-down">
        <div class="row">
          ...
          <div class="col-lg-12 who-we-are-bottom">
            ...
            <div class="ser_column">
				    <div class="c_col">
				    
                    <p>An efficient transportation system comprising fast and sustainable automobiles is vital for the societies of today and tomorrow. Our report store related to automotive & transportation includes a wide range of topics, from individual titanium blisks, which make up aircraft engines; to complex autonomous vehicles, which drive themselves. Our industry knowledge spreads across all means of transportation, including land, air, and marine; and all the modes, such as cars, two- and three-wheelers, trains, ships, and aircraft.</p>

				        <div class="hidden_page" style="display: none;">
				            
				            <p>Our commitment to our clients resonates with the global environmental initiatives, reflected in our research focus on sustainable automotive & transportation technologies, such as electric & hybrid powertrains, hydrogen fuel cells, solar-powered vehicles, engines that comply with the latest global emission norms, Li-ion propulsion batteries, energy-efficient AC/DC traction motors, railway electrification, biofuels, and emission reduction systems.</p>
				        </div>
				        
				        <div class="ser_action c1" style="display:block;">
				            <a href="Javascript:void(0);" id="view_more" class="find_more" style="display: block;">Read More</a>
				            <a href="Javascript:void(0);" id="close" class="close_btn close_icon-2" style="display: none;">close</a>
				        </div>
				    </div>
				</div>
