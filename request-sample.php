        ...
        <div class="row" style="justify-content: space-between;">
            ...
            <div class="col-lg-9 justify-content-center">
                <div class="io-checkout-form" style="padding: 5px 0 !important;">
                    <div class="BilTitle" style="font-size: 15px;">To receive free sample pages of this report, please complete the form below:
                        <div class="back-to-report">
                    <a href="#" class="back-report">
...
<form action="#" method="POST" name="" style="margin-top: 10px;">
           ...
           <div class="io-license-type-button-form">
             <a href="checkout.php">Buy Now</a>
                        ...
                        <!-- <div class="io-buy-report">
                             <a href="checkout.php" target="_blank" class="buy-report">Buy Report</a>
                         </div> -->
                         <!-- <div class="io-request-custom">
                             <a href="request-customization.php" target="_blank" class="request-customization" style="margin-top: 9px;">Request Customization</a>
                         </div> -->
